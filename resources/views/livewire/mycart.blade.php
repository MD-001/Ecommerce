       ...
       {{-- {{ dd($cartItem); }}  --}}
            ...
            <div class="row border-top border-bottom">
                <div class="row main align-items-center">
                    ...
                    <div class="col">
                        <a href="#" wire:click="$emit('decrement', {{$cartItem->id}}, {{$cartItem->qty}})" class="text-decoration-none fs-5 fw-bold">-</a><a href="#" class="border">{{ $cartItem->qty }}</a><a href="#" wire:click="$emit('increment', {{$cartItem->id}}, {{$cartItem->qty}})" class="text-decoration-none fw-bold">+</a>
                    </div>
                    {{-- {{ $cartItem->rowId }} --}}
