...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Admin center</a>
            <!-- Sidebar Toggle-->
                        ...
                        <div class="row justify-content-center">
                            <form method="POST" action="{{ route('marque.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="libelle" type="text" class="form-control" name="libelle" required autocomplete="libelle" autofocus>
                                    </div>
                                </div>
                                <div class="row mb-3">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Notre Site 2023</div>
                            <div>
